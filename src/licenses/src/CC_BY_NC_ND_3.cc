...
#include "CC_BY_NC_ND_3.hpp"

namespace licenser::licenses {
CC_BY_NC_ND_3_::CC_BY_NC_ND_3_() : License(LicenseType::CC_BY_NC_ND_3) {}

std::string CC_BY_NC_ND_3_::body_to_string() const {
...
std::string CC_BY_NC_ND_3_::header_to_string() const {
...
work.  If not, see <http://creativecommons.org/licenses/by-nc-nd/3.0/>.)i_like_naruto";
}

std::string CC_BY_NC_ND_3_::name() const {
