...
CC_BY_3_::CC_BY_3_() : License(LicenseType::CC_BY_3) {}

std::string CC_BY_3_::body_to_string() const {
...
std::string CC_BY_3_::header_to_string() const {
  return R"i_like_naruto(%PROJECT% (c) by %AUTHOR% %EMAIL%
%PROJECT% is licensed under a
Creative Commons Attribution 3.0 Unported License.
  
You should have received a copy of the license along with this
work.  If not, see <http://creativecommons.org/licenses/by/3.0/>.)i_like_naruto";
}

std::string CC_BY_3_::name() const {
